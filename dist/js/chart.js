...
},{"./vendor/sankey":3,"d3":1}],3:[function(require,module,exports){
d3.sankey = function() {
    var sankey = {},
        nodeWidth = 24,
        nodePadding = 8,
    ...
    sankey.link = function() {
        ...
        function link(d) {
            // debugger
            var x0 = d.source.step * segmentWidth,
                x1 = d.target.step * segmentWidth,
                xi = d3.interpolateNumber(x0, x1),
                x2 = xi(curvature),
                x3 = xi(1 - curvature),
                y0 = (levels - d.source.level) * segmentHeight,
                y1 = (levels - d.target.level) * segmentHeight;
