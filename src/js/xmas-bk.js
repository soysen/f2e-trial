...
class rocket {
  constructor(id) {
    ...
    this.giftScore = new createjs.Text("YOU HAVE " + this.catchGift + " GIFTS", "bold 2em Oswald", "#FFFFFF");
  ...
  startGame(e) {
    ...
    this.giftScore.textAlign = 'right';
    this.giftScore.x = 420;
    this.giftScore.y = 20;
    this.stage.addChild(this.giftScore);
